...
Citation: Y. Küçükçiloğlu, B. Sekeroglu, T. Adalı, N. Şentürk, Prediction of osteoporosis using MRI and CT scans with unimodal and multimodal deep-learning models, Diagnostic and Interventional Radiology, 2023.
